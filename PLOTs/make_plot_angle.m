...
function f = make_plot_angle(solution,Grid_para,constraints,range,modeColors)
...
f = figure('Renderer', 'painters', 'Position', [10 10 850 400]);
    hold on 
        data_Vup= angle(solution.V_upstream)*180/pi;
        data_Vdown = angle(solution.V_downstream)*180/pi;
