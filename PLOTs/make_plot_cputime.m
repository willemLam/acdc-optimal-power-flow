...
function f = make_plot_cputime(solution_island,solution_connected,range)
...
hold on
h1 = cdfplot(solution_island.duration(range));
h2 = cdfplot(solution_connected.duration(range));

set( h1, 'LineWidth', 2, 'Color', m_cmap(1,:));
set( h2, 'LineWidth', 2, 'Color', m_cmap(7,:));
