...
PrevConvergeParams = struct('State',0,'VmpErrMeanChange',10000); % Initialize a struct for PrevConvergeParams, required for first run through of check_converge
if graphic
    h = figure();
end
if graphic
...
if isempty (ConvergeParam.ImpErrMax) 
    ConvergeParam.ImpErrMax=NaN;
end

if isempty (ConvergeParam.ImpErrMin) 
    ConvergeParam.ImpErrMin=NaN;
end

if isempty (ConvergeParam.ImpErrMin) 
    ConvergeParam.ImpErrMin=NaN;
end
if isempty (ConvergeParam.ImpErrAbsMax) 
    ConvergeParam.ImpErrAbsMax=NaN;
end
  
if isempty (ConvergeParam.VmpErrMin) 
    ConvergeParam.VmpErrMin=NaN;
end
...
if isempty (ConvergeParam.VmpErrAbsMax) 
    ConvergeParam.VmpErrAbsMax=NaN;
end


if isempty (ConvergeParam.PmpErrMin) 
    ConvergeParam.PmpErrMin=NaN;
end
...
if isempty (ConvergeParam.PmpErrAbsMax) 
    ConvergeParam.PmpErrAbsMax=NaN;
end


if isempty(ConvergeParam.VmpErrStdChange)
    
ConvergeParam.VmpErrStdChange=NaN;

end

if isempty(ConvergeParam.PmpErrStdChange)
    
ConvergeParam.PmpErrStdChange=NaN;

end

if isempty(ConvergeParam.ImpErrMeanChange)
    
ConvergeParam.ImpErrMeanChange=NaN;

end

if isempty(ConvergeParam.VmpErrMeanChange)
    
ConvergeParam.VmpErrMeanChange=NaN;

end

if isempty(ConvergeParam.PmpErrMeanChange)
    
ConvergeParam.PmpErrMeanChange=NaN;

end

if isempty(ConvergeParam.ImpErrStdChange)
    
ConvergeParam.ImpErrAbsChange=NaN;

end

if isempty(ConvergeParam.VmpErrStdChange)
    
ConvergeParam.VmpErrAbsChange=NaN;

end

if isempty(ConvergeParam.PmpErrStdChange)
    
ConvergeParam.PmpErrAbsChange=NaN;

end


if isempty(ConvergeParam.ImpErrAbsMaxChange)
    
ConvergeParam.ImpErrAbsMaxChange=NaN;

end

if isempty(ConvergeParam.PmpErrAbsMaxChange)
    
ConvergeParam.PmpErrAbsMaxChange=NaN;

end



if isempty(ConvergeParam.VmpErrAbsMaxChange)
    
ConvergeParam.VmpErrAbsMaxChange=NaN;
