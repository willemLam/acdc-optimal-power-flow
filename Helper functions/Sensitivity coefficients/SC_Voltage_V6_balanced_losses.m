function [K, Time] = SC_Voltage_V6_balanced_losses(S_star,E_star_augmented,idx1_augmented,idx3_augmented,Grid_para_augmented,Filter_para,idxCtrl,unblanced_3ph,filter)
...
A16a = [dP_mag(idx.pqac,idx.vscac_vq_v) dP_ang(idx.pqac,idx.vscac_vq_v);
       dQ_mag(idx.pqac,idx.vscac_vq_v) dQ_ang(idx.pqac,idx.vscac_vq_v)];
% A16   magE, angE (vscac_vq_q
A16b = [dP_mag(idx.pqac,idx.vscac_vq_q) dP_ang(idx.pqac,idx.vscac_vq_q);
       dQ_mag(idx.pqac,idx.vscac_vq_q) dQ_ang(idx.pqac,idx.vscac_vq_q)];
...
A26a = [dP_mag(idx.pvac,idx.vscac_vq_v) dP_ang(idx.pvac,idx.vscac_vq_v);
       dV_mag(idx.pvac,idx.vscac_vq_v) dV_ang(idx.pvac,idx.vscac_vq_v)];
% A26   magE, angE (vscac_vq)
A26b = [dP_mag(idx.pvac,idx.vscac_vq_q) dP_ang(idx.pvac,idx.vscac_vq_q);
       dV_mag(idx.pvac,idx.vscac_vq_q) dV_ang(idx.pvac,idx.vscac_vq_q)];
% A27   Edc (vscdc_p)
...
A36a = [dP_mag(idx.pdc,idx.vscac_vq_v) dP_ang(idx.pdc,idx.vscac_vq_v)];
% A16   magE, angE (vscac_vq)
A36b = [dP_mag(idx.pdc,idx.vscac_vq_q) dP_ang(idx.pdc,idx.vscac_vq_q)];
% A17   Edc (vscdc_p)
...
% A16   magE, angE (vscac_vq)
A46a = [dP_mag(idx.vdc,idx.vscac_vq_v) dP_ang(idx.vdc,idx.vscac_vq_v)];
% A16   magE, angE (vscac_vq)
A46b = [dP_mag(idx.vdc,idx.vscac_vq_q) dP_ang(idx.vdc,idx.vscac_vq_q)];
% A17   Edc (vscdc_p)
...
A56a = [dP_mag(idx.vscac_pq,idx.vscac_vq_v) dP_ang(idx.vscac_pq,idx.vscac_vq_v);
       dQ_mag(idx.vscac_pq,idx.vscac_vq_v) dQ_ang(idx.vscac_pq,idx.vscac_vq_v)];
% A56   magE, angE (vscac_vq)
A56b = [dP_mag(idx.vscac_pq,idx.vscac_vq_q) dP_ang(idx.vscac_pq,idx.vscac_vq_q);
       dQ_mag(idx.vscac_pq,idx.vscac_vq_q) dQ_ang(idx.vscac_pq,idx.vscac_vq_q)];
% A57   Edc (vscdc_p)
...
A6a1 = [dP_mag(idx.vscac_vq_v,idx.pqac) dP_ang(idx.vscac_vq_v,idx.pqac);
       dQ_mag(idx.vscac_vq_v,idx.pqac) dQ_ang(idx.vscac_vq_v,idx.pqac)];
% A62   Q   ,angE (idx.pvac)
A6a2 = [zeros(length(idx.vscac_vq_v),length(idx.pvac)) dP_ang(idx.vscac_vq_v,idx.pvac);
       zeros(length(idx.vscac_vq_v),length(idx.pvac)) dQ_ang(idx.vscac_vq_v,idx.pvac)];
% A63   Edc (idx.pdc)

index_vsc_v = repmat(idx.vscdc_vq,1,n_ph)';
A6a3 = [dP_mag(index_vsc_v,idx.pdc); %!!!! maybe x and y have to be swapped
       dQ_mag(idx.vscac_vq_v,idx.pdc)]; %index_vsc_v??
% A64   Pdc (idx.vdc)
A6a4 = [zeros(length(idx.vscac_vq_v),length(idx.vdc));
       zeros(length(idx.vscac_vq_v),length(idx.vdc))];
% A65   magE, angE (vscac_pq)
A6a5 = [dP_mag(idx.vscac_vq_v,idx.vscac_pq) dP_ang(idx.vscac_vq_v,idx.vscac_pq);
       dQ_mag(idx.vscac_vq_v,idx.vscac_pq) dQ_ang(idx.vscac_vq_v,idx.vscac_pq)];
% A66   magE, angE (vscac_vq)
A6a6a = [dP_mag(idx.vscac_vq_v,idx.vscac_vq_v) dP_ang(idx.vscac_vq_v,idx.vscac_vq_v);
       dQ_mag(idx.vscac_vq_v,idx.vscac_vq_v) dQ_ang(idx.vscac_vq_v,idx.vscac_vq_v)];
% A66   magE, angE (vscac_vq)
A6a6b = [dP_mag(idx.vscac_vq_v,idx.vscac_vq_q) dP_ang(idx.vscac_vq_v,idx.vscac_vq_q);
       dQ_mag(idx.vscac_vq_v,idx.vscac_vq_q) dQ_ang(idx.vscac_vq_v,idx.vscac_vq_q)];
% A67   Edc (vscdc_p)
A6a7 = [dP_mag(idx.vscac_vq_v,idx.vscdc_pq);
       dQ_mag(idx.vscac_vq_v,idx.vscdc_pq)];
   
%% VSC VdcQ_Q
% A61   magE, angE (idx.pqac)
A6b1 = [dP_mag(idx.vscac_vq_q,idx.pqac) dP_ang(idx.vscac_vq_q,idx.pqac);
       dQ_mag(idx.vscac_vq_q,idx.pqac) dQ_ang(idx.vscac_vq_q,idx.pqac)];
% A62   Q   ,angE (idx.pvac)
A6b2 = [zeros(length(idx.vscac_vq_q),length(idx.pvac)) dP_ang(idx.vscac_vq_q,idx.pvac);
       zeros(length(idx.vscac_vq_q),length(idx.pvac)) dQ_ang(idx.vscac_vq_q,idx.pvac)];
% A63   Edc (idx.pdc)
A6b3 = [dP_mag(idx.vscac_vq_q,idx.pdc);
       dQ_mag(idx.vscac_vq_q,idx.pdc)];
% A64   Pdc (idx.vdc)
A6b4 = [zeros(length(idx.vscac_vq_q),length(idx.vdc));
       zeros(length(idx.vscac_vq_q),length(idx.vdc))];
% A65   magE, angE (vscac_pq)
A6b5 = [dP_mag(idx.vscac_vq_q,idx.vscac_pq) dP_ang(idx.vscac_vq_q,idx.vscac_pq);
       dQ_mag(idx.vscac_vq_q,idx.vscac_pq) dQ_ang(idx.vscac_vq_q,idx.vscac_pq)];
% A66   magE, angE (vscac_vq)
A6b6a = [dP_mag(idx.vscac_vq_q,idx.vscac_vq_v) dP_ang(idx.vscac_vq_q,idx.vscac_vq_v);
       dQ_mag(idx.vscac_vq_q,idx.vscac_vq_v) dQ_ang(idx.vscac_vq_q,idx.vscac_vq_v)];
% A66   magE, angE (vscac_vq)
A6b6b = [dP_mag(idx.vscac_vq_q,idx.vscac_vq_q) dP_ang(idx.vscac_vq_q,idx.vscac_vq_q);
       dQ_mag(idx.vscac_vq_q,idx.vscac_vq_q) dQ_ang(idx.vscac_vq_q,idx.vscac_vq_q)];
% A67   Edc (vscdc_p)
A6b7 = [dP_mag(idx.vscac_vq_q,idx.vscdc_pq);
       dQ_mag(idx.vscac_vq_q,idx.vscdc_pq)];
...
A76a = [dP_mag(idx.vscdc_pq,idx.vscac_vq_v) dP_ang(idx.vscdc_pq,idx.vscac_vq_v)];
% A76   magE, angE (vscac_vq)
A76b = [dP_mag(idx.vscdc_pq,idx.vscac_vq_q) dP_ang(idx.vscdc_pq,idx.vscac_vq_q)];
% A77   Edc (vscdc_p)
      ...
      switch( node_type )
         case 1 % slack node
             if (ctrl_var == 1) 
                ...
                u6a = [- dV_mag(idx.vscac_vq_v,tmp_idx);
                      - dQ_mag(idx.vscac_vq_v,tmp_idx)];
                u6b = [- dV_mag(idx.vscac_vq_q,tmp_idx);
                      - dQ_mag(idx.vscac_vq_q,tmp_idx)];             
             ...
             elseif (ctrl_var == 2) 
                ...
                u6a = [- dV_ang(idx.vscac_vq_v,tmp_idx);
                      - dQ_ang(idx.vscac_vq_v,tmp_idx)];
                u6b = [- dV_ang(idx.vscac_vq_q,tmp_idx);
                      - dQ_ang(idx.vscac_vq_q,tmp_idx)];
          ...
          case 10 % vscdc_vq node
              if (ctrl_var == 1) 
                ...
                u5 = [zeros(length(idx.vscac_pq),1);
                      zeros(length(idx.vscac_pq),1)];
                u6a = [-dP_mag(index_vsc_v,tmp_idx);
                      zeros(length(idx.vscac_vq_v),1)];
                u6b = [zeros(length(idx.vscac_vq_q),1);
                      zeros(length(idx.vscac_vq_q),1)];
                u7 = [zeros(length(idx.vscdc_pq),1)];
