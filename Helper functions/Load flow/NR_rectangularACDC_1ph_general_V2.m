function [E,J,n_iter,time] = NR_rectangularACDC_1ph_general_V2(Grid_para,Filter_para,S_star,E_star,E_0,idx,tol,n_max)
% INPUT
% - Grid_para   
% - Filter_para
...
for k=1:n_max
    ...
    dF = Mismatch_1ph_V2(E,S,E_star,S_star,Grid_para,Filter_para,idx);
...
%     [J_PpR, J_PpX, J_QpR, J_QpX] = Jacobian_Powers_symmetric(E_re, E_im, Grid_para, J_PpR, J_PpX, J_QpR, J_QpX);
    ...
    [J_AFEiR, J_AFEiX, J_AFErR, J_AFErX] = Jacobian_Converters_1ph_V2(E_re,E_im, E_star, Grid_para, Filter_para, J_EdiorR, J_EdiorX, J_EdioiR, J_EdioiX, J_PR, J_PX, J_QR, J_QX, J_AFEiR, J_AFEiX, J_AFErR, J_AFErX);
