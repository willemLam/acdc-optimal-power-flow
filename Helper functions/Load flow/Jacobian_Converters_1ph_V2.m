function [J_AFEiR, J_AFEiX, J_AFErR, J_AFErX] = Jacobian_Converters_1ph_V2(E_re,E_im, E_star, Grid_para, Filter_para, J_EdiorR, J_EdiorX, J_EdioiR, J_EdioiX, J_PR, J_PX, J_QR, J_QX, J_AFEiR, J_AFEiX, J_AFErR, J_AFErX)
...
%                     disp('Warning: alpha is wrong')
            ...
            % l real
            J_AFErR(pos_ac3(p,1),pos_ac3(p,1) ) = 0;
            % j
...
%                     disp('Warning: alpha is wrong')
            ...
            % l imag
            J_AFEiX(pos_ac3(p,1),pos_ac3(p,1) ) = 0;
