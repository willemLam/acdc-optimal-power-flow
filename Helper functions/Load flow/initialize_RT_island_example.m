function [Grid_para, Filter_para, idx1, idx3, constraints] = initialize_RT_island()
    ...
    [Yac, YYLac, YLac, YTac, YYTac, I_bac, Ampacitiesac, y_lx, y_tx, Aac, linedata_ac]  = Ymatrix_non_sym_shunt('linedata_AC_LCL_test2.txt',A_b,V_b,[]);
    [Ydc, YYLdc, YLdc, YTdc, YYTdc, I_bdc, Ampacitiesdc, y_ihdc, y_idc, Adc, linedata_dc]  = Ymatrix_non_sym_shunt('linedata_DC_LCL_test2.txt',Adc_b,Vdc_b,[]);
    ...
    %% Data from SCADA
    Grid_para.SCADA_bus = [1:8];
    Grid_para.SCADA_line = [1:6];
