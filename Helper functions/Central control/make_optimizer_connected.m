function [solution,OPF_termination] = make_optimizer_connected(Grid_para,idx,constraints,variables,prev_solution,OPF_termination)
...
cost.sum = cost.IC.E + 0*cost.loss  + cost.PV_P + cost.IC.Q + cost.PV_Q + cost.slack.Q + cost.sambat + cost.supcap; 
...
solution.P_supcap = double(optimal.SupCap_P);
