...
if     SM_info.mode == "Grid connected"
    cost.sum = 0*100*cost.I_afe_norm + 100*cost.SOC_sc_norm + 0.1*cost.E_dc_norm + 0*cost.loss_norm + 5*cost.Q_afe_norm + 0.5*cost.P_afe23_norm + 10*cost.PCC_q_norm + cost.P_samsung_norm; 
...
elseif SM_info.mode == "Island"
    cost.sum = 0*100*cost.I_afe_norm + 100*cost.SOC_sc_norm + 0.1*cost.E_dc_norm + 0*cost.loss_norm + 5*cost.Q_afe_norm + 0.5*cost.P_afe23_norm + 10*cost.PCC_q_norm + 0.1*cost.P_samsung_norm + cost.PCC_p_norm + 10*cost.Q_afe1_norm; 
