...
for m=1:length(modes)
    ...
    switch mode
        case 'P30'
            S_star2(30) = S_star2(30) + ad;
        case 'E26'
            E_star2(26) = E_star2(26) + ad;
        case 'Q22'
            S_star2(22) = S_star2(22) + ad*1i;
        case 'Q9'
            S_star2(9) = S_star2(9) + ad*1i;
        case 'P9'
            S_star2(9) = S_star2(9) + ad;
        case 'E27'
            E_star2(27) = E_star2(27) + ad;
...
%% step 2 -> validate SC constraints
